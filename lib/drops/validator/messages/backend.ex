defmodule Qol.Drops.Validator.Messages.Backend do
  @moduledoc ~S"""
  ...
  ## Examples
      ...
      ...>   use Qol.Drops.Validator.Messages.Backend
      ...>
      ...
      ...>   use Qol.Drops.Contract, message_backend: MyBackend
      ...>
      ...>   schema do
      ...>     %{
      ...
      {:error,
        [
          %Qol.Drops.Validator.Messages.Error.Type{
            path: [:email],
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour Qol.Drops.Validator.Messages.Backend

      alias Qol.Drops.Validator.Messages.Error
